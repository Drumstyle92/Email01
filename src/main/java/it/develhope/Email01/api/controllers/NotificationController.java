package it.develhope.Email01.api.controllers;
...
import it.develhope.Email01.students.entities.Student;
import it.develhope.Email01.students.services.StudentService;
...
public class NotificationController {
    ...
    public ResponseEntity<String> sendEmailToStudent(@PathVariable String id, @RequestBody NotificationDTO notificationDTO) {
        ...
        try {
            ...
            Email from = new Email("Name@example.com");
